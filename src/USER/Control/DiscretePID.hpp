...
#ifndef USER_CONTROL_DISCRETE_PID_HPP_INCLUDED_
#define USER_CONTROL_DISCRETE_PID_HPP_INCLUDED_
...
namespace USER
{
  namespace Control
  {
    ...
    public:
      ...
      void
      enableParcels(DUNE::Tasks::Task* t, DUNE::IMC::ControlParcel* p);
    ...
    private:
      ...
      DUNE::IMC::ControlParcel* m_parcel;
    };
  }
}
